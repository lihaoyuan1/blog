  ...
  <div>
    <el-card>
      ...
      <p style="font-size: 15px">
        李浩元，一枚在校大学生，喜欢编程，热爱学习新技术，目前正在前后端道路上摸索，目标是成为一名全栈攻城狮。
      </p>
      ...
      <el-row>
        ...
        <el-col :span="2">
          <el-popover placement="bottom" width="120" trigger="hover">
            <img src="../../../static/me-qrcode.png" width="140" alt="" />
    ...
    <el-card style="margin-top: 10px">
      <el-image
        src="https://blog-lhy.oss-cn-hangzhou.aliyuncs.com/author_info/about.jpg"
        lazy
      />
    </el-card>
  </div>
